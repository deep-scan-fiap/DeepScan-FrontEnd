    ...
    <div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    size={24}
                    className={`text-[#1da2d8] flex-shrink-0 transition-transform ${
                ...
                >
                  <div className="px-6 pb-5 text-[#76b6c4] leading-relaxed">
                    {faq.answer}
                  </div>
                </div>
              </div>
          ...
          {/* Contact Section */}
          <div className="mt-12 p-8 bg-gradient-to-br from-[#1da2d8] to-[#7fcdff] rounded-2xl text-white text-center">
